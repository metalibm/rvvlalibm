 ...
 *     --target rv64gv --precision double --function log2 --output \
 *     vla_log2_double.c --fname vla_log2_double
 *
 */
...
void vla_log2_double(double* dst, double* src, uint32_t len){
    int32_t remLen;
    int32_t offset;
    ...
    for (;(remLen > INT32_C(0));){
        ...
        tmp69 = vfmul_vf_f64m1(rh, 0x1.71547652b82fep0, l);
        tmp70 = vfsub_vv_f64m1(rh, tmp53, l);
        rl = vfsub_vv_f64m1(tmp68, tmp70, l);
        tmp71 = vfmsub_vf_f64m1(rh, 0x1.71547652b82fep0, tmp69, l);
        tmp72 = vfmadd_vf_f64m1(rh, 0x1.777d0ffda0d24p-56, tmp71, l);
        tmp73 = vfmadd_vf_f64m1(rl, 0x1.71547652b82fep0, tmp72, l);

 ...
 *     --target rv64gv --precision double --function log10 --output \
 *     vla_log10_double.c --fname vla_log10_double
 *
 */
...
void vla_log10_double(double* dst, double* src, uint32_t len){
    int32_t remLen;
    int32_t offset;
    ...
    for (;(remLen > INT32_C(0));){
        ...
        rh = vfadd_vv_f64m1(tmp53, tmp68, l);
        tmp69 = vfmul_vf_f64m1(rh, 0x1.bcb7b1526e50ep-2, l);
        tmp70 = vfsub_vv_f64m1(rh, tmp53, l);
        rl = vfsub_vv_f64m1(tmp68, tmp70, l);
        tmp71 = vfmsub_vf_f64m1(rh, 0x1.bcb7b1526e50ep-2, tmp69, l);
        tmp72 = vfmadd_vf_f64m1(rh, 0x1.95355baaafad3p-57, tmp71, l);
        tmp73 = vfmadd_vf_f64m1(rl, 0x1.bcb7b1526e50ep-2, tmp72, l);
        result = vfadd_vv_f64m1(tmp69, tmp73, l);
        tmp74 = dst + offset;
        vse64_v_f64m1(tmp74, result, l);
        tmp75 =  (int32_t) l;
        tmp76 = remLen - tmp75;
        remLen = tmp76;
        tmp77 = offset + tmp75;
